...
impl Graph3D {
    pub fn new(gl: &WebGl2RenderingContext) -> Self {
        ...
        gl.bind_buffer(WebGl2RenderingContext::ARRAY_BUFFER, Some(&buffer_position));
        ...
        Self {
            u_normals_rotation: gl
                .get_uniform_location(&program, "u_normals_rotation")
                .unwrap(),
            u_opacity: gl.get_uniform_location(&program, "u_opacity").unwrap(),
            u_projection: gl.get_uniform_location(&program, "u_projection").unwrap(),
            program: program,
    ...
    pub fn render(
        ...
        gl.bind_buffer(WebGl2RenderingContext::ARRAY_BUFFER, Some(&self.y_buffer));
        gl.vertex_attrib_pointer_with_i32(1, 1, WebGl2RenderingContext::FLOAT, false, 0, 0);
